...
const companyProductImages: Record<string, string> = {
  "Tesla": "https://images.unsplash.com/photo-1562053342-7280b39e6 96c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
...
export const getCompanyProductImage = (companyName: string): string => {
  ...
  if (companyProductImages[companyName]) {
    return companyProductImages[companyName];
  }
